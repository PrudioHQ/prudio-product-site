...
$(document).ready(function(e){$("#form_sendemail").submit(function(e){return $.ajax({url:"sendmail.php",type:"POST",data:$(this).serialize(),dataType:"json",beforeSend:function(e){$(".contact__form").fadeTo("slow",.33),$("#form_sendemail .has-error").removeClass("has-error"),$("#form_sendemail .help-block").html(""),$("#form_message").removeClass("alert-success").html("")},success:function(e,a){e.error&&(e.error.name&&($('#form_sendemail input[name="name"]').parent().addClass("has-error"),$('#form_sendemail input[name="name"]').next(".help-block").html(e.error.name)),e.error.email&&($('#form_sendemail input[name="email"]').parent().addClass("has-error"),$('#form_sendemail input[name="email"]').next(".help-block").html(e.error.email)),e.error.message&&($('#form_sendemail textarea[name="message"]').parent().addClass("has-error"),$('#form_sendemail textarea[name="message"]').next(".help-block").html(e.error.message)),e.error.recaptcha&&($("#form-captcha .help-block").addClass("has-error"),$("#form-captcha .help-block").html(e.error.recaptcha))),grecaptcha.reset(),e.success&&($("#form_message").addClass("alert-success").html(e.success),setTimeout(function(){$("#form_message").removeClass("alert-success").html("")},4e3))},complete:function(e,a){$(".contact__form").fadeTo("fast",1)}}),!1})});
...
$(".navbar-nav > li > a").click(function(){$(".navbar-collapse").collapse("hide")}),$(".wrapper").waypoint(function(){return $(".navbar").toggleClass("js-navbar-top"),$(".navbar.js-toggleClass").toggleClass("navbar-default navbar-inverse"),!1},{offset:"-20px"}),$(".wrapper .navbar-collapse").on("show.bs.collapse",function(){$(".navbar.js-navbar-top").toggleClass("navbar-default navbar-inverse"),$(".navbar").toggleClass("js-toggleClass js-noToggleClass")}),$(".wrapper .navbar-collapse").on("hide.bs.collapse",function(){$(".navbar.js-navbar-top").toggleClass("navbar-default navbar-inverse"),$(".navbar").toggleClass("js-toggleClass js-noToggleClass")}),$(".js-toggle-sidebar").on("click",function(){return $(".wrapper").toggleClass("js-wrapper-aside"),$(".navbar").toggleClass("js-navbar-aside"),$(".sidebar").toggleClass("js-sidebar-aside"),!1}),$(document).ready(function(){var a=$("#review__carousel");a.owlCarousel({items:2,itemsDesktop:[1199,2],itemsDesktopSmall:[991,2],itemsTablet:[768,2],itemsTabletSmall:!1,itemsMobile:[479,1],navigation:!0,slideSpeed:600,pagination:!1,navigationText:['<i class="oi oi-arrow-left"></i>','<i class="oi oi-arrow-right"></i>']})}),$.fn.peity.defaults.donut={delimiter:null,fill:["#F67280","#eee"],height:null,innerRadius:68,radius:70,width:null},$(document).ready(function(){$(".js-skills__item_first").waypoint(function(){setTimeout(function(){$(".skills__item").css("visibility","visible")},11),$(".skills-item__donut").each(function(){function a(){setTimeout(function(){t=i+"/"+r,s.text(t).change(),i+=c,o>=i&&a()},10)}var e=$(this),s=e.peity("donut"),t="",i=0,n=e.html(),l=n.split("/"),o=l[0],r=l[1],c=o/100;a()}),this.destroy()},{offset:"bottom-in-view"})}),$(document).ready(function(){var a=document.querySelectorAll(".svg-inject");SVGInjector(a)}),$(".wow").each(function(){var a=$(this).height();$(this).attr("data-wow-offset",a)}),(new WOW).init();